...
extern void parse_non_void_func_call(std::string &res, _dtype &data_type, const std::string &id);
extern void parse_array_read(std::string &res, _dtype &dtype, const std::string &id);
 ...
 *          array read
 */
void parse_factor(std::string &res, _dtype &dtype);
void parse_exp1(std::string &res, _dtype &res_dtype);/* (backward) ++ -- */
void parse_exp2(std::string &res, _dtype &res_dtype);/* (frontward) ++ -- + - !*/
...
void parse_exp13(std::string &res, _dtype &res_dtype);/* ? : */
void parse_exp14(std::string &res, _dtype &res_dtype);/* , */
